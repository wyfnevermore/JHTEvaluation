    ...
    <table style="margin:10px 10px 10px 10px;width: 98%">
		<tbody>
			<tr height="30px">
				...
				<td width="12%"><input type="text" class="form-control parsley-validated" name="organizationId"></td>
				...
				<td width="12%"><label style="float: left"><input type="text" class="form-control parsley-validated" name="processName" code="" data-required="true"></label></td>
