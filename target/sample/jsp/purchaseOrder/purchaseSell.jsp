...
<meta charset="utf-8" />
  ...
  <script src="<%=path%>/js/purchaseOrder/purchaseSell.js"></script>
        ...
        <section class="vbox">
          <section class="scrollable padder">
            <section class="panel panel-default">
              <header class="panel-heading" style="font-size:20px;">经销产品采购</header>
              <div class="row text-sm wrapper">
               <table style="text-align: right;" class="table b-t b-light text-sm">
              <tbody id="addma1">
                <tr>
                  <td width="100px;"><label>项目号：</label></td>
              ...
              <div class="table-responsive">
                <table id="purchaseSell" style="width: 100%;border-collapse: collapse;table-layout: fixed;" class="table table-striped b-t b-light text-sm">
                </table>
              </div>
            </section>
          </section>
