...
//	}
	...
	window.parent.$hireCost_result = getCost();
...
function addHireRow(){
	...
	var html = "<tr><td><select style=\"width:150px;\" class=\"input-sm form-control input-s-sm inline\">"
      +"<option value=\"第一提佣人\">第一提佣人</option>" 
      +"<option value=\"第二提佣人\">第二提佣人</option>"
      +"<option value=\"第三提佣人\">第三提佣人</option>"
	  +"<option value=\"返点率\">返点率</option></select></td>"
