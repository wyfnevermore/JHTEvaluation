...
function getPurchaseOrderHistory(){
  var data = $("#PurchaseOrderQoLineSearchForm").serialize();
  var url = "/JHTEvaluation/getPurchaseOrderHistory.do";
...
function initTable(json){  
	...
	var url = path+"/dataBase-config/eval_purchaseOrder.data"; 
   var $table = $('#purchaseHistory');  
   ...
   $table.bootstrapTable({  
      ...
      // sidePagination: "server", //服务端处理分页  
             columns: [  
                     ...
                     {title: '采购单号',field: 'headerId',align: 'center',valign: 'middle'},
                     {title: '业务模式',field: 'orgCode',align: 'center',valign: 'middle'},
                     {title: '项目号',field: 'projectNumber',align: 'center',valign: 'middle'},
                     {title: '供应商',field: 'vendorName',align: 'center',valign: 'middle'},  
                     {title: '创建日期',field: 'createTime', align: 'center',valign: 'middle'},  
                     {title: '销售订单状态',field: 'salesOrderStatus',align: 'center',valign: 'middle'}, 
                     {title: '成品',field: 'productName',align: 'center',valign: 'middle'}, 
                     {title: '工单状态',field: 'jobOrderStatus', align: 'center',valign: 'middle'},  
