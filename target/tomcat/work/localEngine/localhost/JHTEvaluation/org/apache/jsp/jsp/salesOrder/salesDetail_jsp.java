...
public final class salesDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String path=request.getContextPath(); 
      ...
      out.write("  <script src=\"");
      out.print(path);
      out.write("/js/salesOrder/salesDetail.js\"></script>\n");
      ...
      out.write("              <header class=\"panel-heading\">  <h3 class=\"m-b-none\">销售订单明细汇总</h3> </header>\n");
      ...
      out.write("                     <td>S/B</td>\n");
      out.write("                     <td>$20</td>\n");
      out.write("                     <td><a title=\"工单预览\" href=\"\" class=\"active\"><i class=\"fa fa-file-o\"></i></a>\n");
      out.write("                     <a onclick=\"addProduct();\" href=\"javaScript:void(0);\"><i class=\"fa fa-plus\"></i></a>  \n");
      out.write("                     </td>\t\n");
      out.write("                    </tr>\n");
      out.write("\t\t\t\t\t</tbody>\n");
      out.write("\t\t\t\t    </table>\n");
      ...
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t<div style=\"height:300px\" class=\"panel-body\" id=\"jobOrder1\">\n");
      out.write("\t\t\t\t\t<div class=\"tab-content\"  style=\"margin-bottom:20px\">\n");
      out.write("\t\t\t\t\t<label style=\"height: 35px;width:150px;float:right;\" class=\"btn btn-sm btn-default\">\n");
      out.write("                      <input type=\"checkbox\" name=\"options\" id=\"option1\">  加入生产加工合同 </label>\n");
      out.write("\t\t\t     \t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t</section>\n");
      ...
      out.write("            \t<a class=\"btn btn-s-md btn-primary-W\" style=\"width:60px\" href=\"javaScript:void(0);\" onclick=\"updateSharePrice();\">提交</a>\n");
      out.write("               </div>\n");
      out.write("              \t\t</section>\t\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
