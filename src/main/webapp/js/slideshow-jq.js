...
function render(rawOptions) {
	...
	slideshowOptions[elementID] = options;
		...
		var $playWrap = $(
			"<div class='wslide-button-wrap'>" +
				"<span class='wslide-play wslide-button disable-user-select'>" +
					"<span class='wslide-button-inner'>播放 <span class='wslide-button-icon'></span></span>" +
		...
		var $pauseWrap = $(
			"<div class='wslide-button-wrap'>" +
				"<span class='wslide-pause wslide-button disable-user-select'>" +
					"<span class='wslide-button-inner'>暂停 <span class='wslide-button-icon'></span></span>" +
					"<span class='wslide-button-bg'></span>" +
				"</span>" +
			'</div>'
			);
