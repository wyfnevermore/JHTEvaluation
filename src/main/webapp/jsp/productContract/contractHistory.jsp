...
<meta charset="utf-8" />
  ...
  <script src="<%=path%>/js/productContract/contractHistory.js"></script>
        ...
        <section class="vbox">
          <section class="scrollable padder">
            <section class="panel panel-default">
              <header class="panel-heading" style="font-size:20px;">历史生产加工合同 </header>
              <div class="row text-sm wrapper">
               <table style="text-align: right;" class="table b-t b-light text-sm">
              <tbody id="addma1">
                <tr>
                  <td width="80px;"><label>合同号：</label></td>
                  ...
                  <td><select style="width:200px;" class="form-control">
	                    <option value="0">漂染</option>
	                    <option value="1">缝制</option>
	                  </select></td>
