...
<script type="text/javascript" src="<%=path%>/js/evaluation/distribution/productDesNoComp.js"></script>
<script>
	var path = "<%=path%>";
							...
							<tr>
								...
								<tr>
									...
									<td><select style="margin-left:5px;width:70px;height:30px;" class="input-sm form-control input-s-sm inline">
										<option value="0">A版</option>
										<option value="1">B版</option>
										<option value="1">C版</option>
									</select></td>
