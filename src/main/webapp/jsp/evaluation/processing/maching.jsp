...
<script type="text/javascript" src="<%=path%>/js/evaluation/processing/maching.js"></script>
					...
					<div style="min-height: 1000px;" class="panel-body">
						...
						<%-- 	<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane active" id="converter">
							...
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="materialCost">
								<iframe id="materialCostFrame" frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/processing/materialCost.jsp"></iframe>
							</div>
							<!--纸箱成本 -->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="carton">
								<iframe id="cartonCostFrame" frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/processing/cartonCost.jsp"></iframe>
							</div>
							<!--运杂费  -->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="expenses">
								<iframe frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/processing/transportCost.jsp"></iframe>
							</div>
							<!--佣金  -->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="commission">
								<iframe frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/processing/hireCost.jsp"></iframe>
							</div>
							<!--毛利测算 -->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="grossProfit">
								<iframe id="grossProfitFrame" frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/processing/grossProfit.jsp"></iframe>
							</div>
							<!--其他费用-->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="otherCost">
								<iframe frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/processing/otherCost.jsp"></iframe>
							</div>
							<!--测算单预览 -->
...
<script type="text/javascript">
	...
	if(multiComp){
		$("#productDescFrame").attr("src","<%=path%>/jsp/evaluation/processing/productDescription.jsp");
	}else{
		$("#productDescFrame").attr("src","<%=path%>/jsp/evaluation/processing/productDesNoComp.jsp");
	}
</script>
</html>
