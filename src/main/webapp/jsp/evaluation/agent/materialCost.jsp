...
<script type="text/javascript" src="<%=path%>/js/evaluation/agent/materialCost.js"></script>
...
<section style="height:auto;min-height:500px;" class="panel panel-default">
	   ...
	   <table class="table table-striped b-t b-light text-sm">
	         <thead>
	           <tr>
	             <th>产品名称</th>
	             <th>产品描述</th>
	             <th hidden="hidden">HS索引</th>
	             <th>退税税率(%)</th>
	             <th hidden="hidden">产品类型</th>
	             <th>委托工厂</th>
	             <th style="width:100px;">报关金额(￥)</th>
	             <th style="width:100px;">报关金额($)</th>
	...
	<div style="float: right">
      <a href="javascript:saveEvalDetail();" class="btn btn-s-md btn-primary" >进入代理费用测算</a>
    </div>
						...
						<form class="form-horizontal" id="chengpinForm" data-validate="parsley" method="post" onsubmit="return false">
							<table style="text-align: right;" class="table table-striped b-t b-light text-sm">
								<tbody>
									...
									<tr>
										<td><label>报关金额(￥)：</label></td>
										<td><input id="chengpinCost" type="text" class="form-control" data-required="true" data-type="number" onblur="calVal4USD()"></td>
									    <td></td>
									    <td><label>报关金额($)：</label></td>
										<td><input id="chengpinCostU" type="text" class="form-control" data-required="true" data-type="number" onblur="calVal4RMB()"></td>
									</tr>
								</tbody>
							</table>
							<div>
