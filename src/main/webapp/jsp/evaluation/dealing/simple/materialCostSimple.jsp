...
<script type="text/javascript" src="<%=path%>/js/evaluation/dealing/simple/materialCostSimple.js"></script>
...
<section style="height:auto;min-height:500px;" class="panel panel-default">
	...
	<div style="float: right">
      <a href="javascript:saveEvalDetail();" class="btn btn-s-md btn-primary" >进入运杂费测算</a>
    </div>
							...
							<table style="text-align: right;" class="table table-striped b-t b-light text-sm">
								<tbody>
									...
									<tr>
										...
										<td><input id="productSize" type="text" class="form-control" ></td>
										<td></td>
									...
									<tr>
										...
										<td></td>
										<td><label>工厂报价条件：</label></td>
										<td><input id="deliverPattern" type="text" class="form-control"></td>
									</tr>
									<tr>
										<td><label>产品描述：</label></td>
										<td colspan="4"><input id="productDescribe" type="text" class="form-control"></td>
									</tr>
									<tr>
										<td><label>退税税率(%)：</label></td>
										<td><input id="drawBackRate" type="text" class="form-control" data-required="true" onfocus="this.blur()"></td>
										<td></td>
										<td><label>产品单价(￥)：</label></td>
