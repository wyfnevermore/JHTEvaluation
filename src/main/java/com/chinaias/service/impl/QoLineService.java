...
@Service
public class QoLineService  extends BaseService<QoLine> implements IQoLineService{

	@Resource
	private IBaseDao<QoLine> baseDao;
	
	//新增
	public String addQoLine(QoLine qoLine) {
		String uuid = UUID.randomUUID().toString().trim().replaceAll("-", "");  
		qoLine.setLineId(uuid);
		try {
			this.baseDao.save(qoLine);
		} catch (Exception e) {
