...
<script type="text/javascript" src="<%=path%>/js/evaluation/agent/maching.js"></script>
				...
				<section style="width: 100%;" class="panel panel-default">
					<header class="panel-heading">
						<div class="panel-body">
							<ul class="nav nav-tabs nav-justified" id="tabUl">
								<li id="materialCost1" class="active"><a href="#materialCost" data-toggle="tab">代理金额测算 </a></li> 
								<!-- <li id="expenses1"><a href="#expenses" data-toggle="tab">代垫费用测算</a></li> -->
								<li id="otherCost1"><a href="#otherCost" data-toggle="tab">代理收费测算</a></li>
					...
					<div style="min-height: 1000px;" class="panel-body">
						<div class="tab-content" id="iframes">
							<!--物料成本  -->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane active" id="materialCost">
								<iframe id="materialCostFrame" frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/agent/materialCost.jsp"></iframe>
							</div>
							<!--运杂费  -->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="expenses">
								<iframe frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/agent/transportCost.jsp"></iframe>
							</div>
							<!--其他费用-->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="otherCost">
								<iframe id="agentFrame" frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/agent/otherCost.jsp"></iframe>
							</div>
							<!--毛利测算 -->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="grossProfit">
								<iframe id="grossProfitFrame" frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/agent/grossProfit.jsp"></iframe>
							</div>
							<!--测算单预览 -->
								...
								<div class="row">
									<div style="width: 100%; float: left;">
										<table style="width: 100%">
											<tr height="30px">
												<td width="10%"><label style="float: right">客户：</label></td>
												<td width="20%"><label id="customerWholeName" style="float: left"></label></td>
												<td width="10%"><label style="float: right">贸易形式：</label></td>
												<td width="20%"><label id="tradeForm" style="float: left"></label></td>
												<td width="10%"><label style="float: right">目的地：</label></td>
												<td width="20%"><label id="country" style="float: left"></label></td>
											</tr>
											<tr>
												<td colspan="8"><div class="line line-dashed line-lg pull-in"></div></td>
											</tr>
											<tr height="30px">
												<td><label style="float: right">报价货币：</label></td>
												<td><label id="quoteCurrency" style="float: left"></label></td>
												<td><label  style="float: right">报价汇率：</label></td>
												<td><label id="quotationRate" style="float: left"></label></td>
												<td><label style="float: right"></label></td>
												<td><label style="float: left"></label></td>
											</tr>
											<tr>
												<td colspan="6"><div class="line line-dashed line-lg pull-in"></div></td>
											</tr>
										</table>
									</div>
...
<script type="text/javascript">
	...
	if(multiComp){
		$("#productDescFrame").attr("src","<%=path%>/jsp/evaluation/agent/productDescription.jsp");
	}else{
		$("#productDescFrame").attr("src","<%=path%>/jsp/evaluation/agent/productDesNoComp.jsp");
	}
</script>
</html>
