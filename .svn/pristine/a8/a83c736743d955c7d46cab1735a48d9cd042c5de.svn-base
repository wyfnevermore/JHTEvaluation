...
$(function() {
	...
	if(evalHeadData.quoteCurrency == "USD"){
		 $("#machingTable").find("tr")[0].children[3].textContent = "产品测算成本（$）";
		 $("#machingTable").find("tr")[0].children[4].textContent = "测算报价（$）";
		 $("#machingTable").find("tr")[0].children[5].textContent = "执行金额（$）";
	 }
