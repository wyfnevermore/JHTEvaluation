$(function(){
  ...
  $("#flot-1ine").length && $.plot($("#flot-1ine"), [{
      ...
      }], 
      {
        ...
        colors: ["#65bd77"],
        xaxis:{
        	ticks: [[1, "1月"], [2, "2月"],[3, "3月"], [4, "4月"],[5, "5月"],[6, "6月"], [7, "7月"], [8, "8月"],[9, "9月"], [10, "10月"],[11, "11月"],[12, "12月"]], min: 1, max: 12.1
        },
        yaxis: {
          ticks: 5
        },
...
var d3_2 = [];
  for (var i = 1; i <= 5; i += 1) {
    d3_2.push([i + 0.2, parseInt((Math.floor(Math.random() * (50))) + 70)]);
  }
  ...
  $("#flot-mainbar").length && $.plot($("#flot-mainbar"), data3, {
      xaxis: {
    	  ticks: [[1, "客户A"], [2, "客户B"],[3, "客户C"], [4, "客户D"],[5, "客户E"]], min: 1, max: 5.5
      },
      yaxes: [
          {
            position: "left",
...
var d4_2 = [];
  for (var i = 1; i <= 5; i += 1) {
    d4_2.push([i+0.2, parseInt((Math.floor(Math.random() * (50))) + 70)]);
  }
  ...
  $("#flot-mainbar2").length && $.plot($("#flot-mainbar2"), data4, {
	  xaxis: {
    	  ticks: [[1, "产品A"], [2, "产品B"],[3, "产品C"], [4, "产品D"],[5, "产品E"]], min: 1, max: 5.5
      },
      yaxes: [
          {
            position: "left",
