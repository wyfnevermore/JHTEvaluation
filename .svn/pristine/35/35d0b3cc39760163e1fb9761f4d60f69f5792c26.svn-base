...
<script type="text/javascript" src="<%=path%>/js/evaluation/dealing/simple/machingSimple.js"></script>
					...
					<header class="panel-heading">
						<div class="panel-body">
							<ul class="nav nav-tabs nav-justified" id="tabUl">
								<li id="materialCost1" class="active"><a href="#materialCost" data-toggle="tab">产品测算 </a></li> 
					...
					<div style="min-height: 1000px;" class="panel-body">
						<div class="tab-content" id="iframes">
							...
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane active" id="materialCost">
								<iframe id="materialCostFrame" frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/dealing/simple/materialCostSimple.jsp"></iframe>
							</div>
							<!--运杂费  -->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="expenses">
								<iframe frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/dealing/simple/transportCostSimple.jsp"></iframe>
							</div>
							<!--佣金  -->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="commission">
								<iframe frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/dealing/simple/hireCostSimple.jsp"></iframe>
							</div>
							<!--毛利测算 -->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="grossProfit">
								<iframe id="grossProfitFrame" frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/dealing/simple/grossProfitSimple.jsp"></iframe>
							</div>
							<!--其他费用-->
							<div style="width: 100%; height: 1000px; min-height: 800px;" class="tab-pane" id="otherCost">
								<iframe frameborder="0" style="width: 100%; height: 100%;" src="<%=path%>/jsp/evaluation/dealing/simple/otherCostSimple.jsp"></iframe>
							</div>
							<!--测算单预览 -->
